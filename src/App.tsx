...
import { Apple, Backpack3, BagCheck, Bell, Calendar2Check, ChatRightQuote, Gear, GridFill, SearchHeart, Wallet } from "react-bootstrap-icons";
  ...
  return (
    <div className="p-0 m-0 outfit-uniquifier " style={{ height: "100vh" }}>
      <Row style={{ height: "100vh" }}>
        <Col md={2} className="ps-8 pt-9">
          <h1 className="fs-4 ps-3 text-cyan-600">Sale.</h1>
          <ListGroup className="pt-4">
            <ListGroup.Item className="border-0 mb-2 pe-0 ps-4 d-flex gap-2 align-items-center title-hover">
              <GridFill />
              Dashboard
            </ListGroup.Item>
            <ListGroup.Item className="border-0 mb-2 pe-0 ps-4 d-flex gap-2 align-items-center title-hover">
        ...
        <Col md={10} className="bg-slate-100 pt-9 ps-5 pe-5">
          <Row>
            <Col md={7}>
              <InputGroup>
                <InputGroup.Text>
                  <SearchHeart className="border-none rounded-none" />
                </InputGroup.Text>
                <Form.Control
                  type="text"
                  placeholder="Search"
            ...
            <Col className="d-flex justify-end">
              <Bell className="bg-white fs-5 h-8 w-8 p-2 me-3 text-secondary">
              </Bell>
              <img
